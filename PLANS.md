...
```yaml
id: upwage/screener/create-endpoint
version: 1
vars:
...
```text
&plan upwage/screener/create-endpoint@v1 route=POST:/job-postings
```
...
[plans]
"screener:add-endpoint" = "upwage/screener/create-endpoint@v1"
```
