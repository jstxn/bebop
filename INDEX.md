...
### Example Artifacts
- [packs/upwage-monorepo-core@v1.md](packs/upwage-monorepo-core@v1.md) - Example pack
- [plans/upwage-screener-create-endpoint@v1.md](plans/upwage-screener-create-endpoint@v1.md) - Example plan
- [projects/upwage-microservices.md](projects/upwage-microservices.md) - Example project config
